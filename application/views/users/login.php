    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s">
          <form id="contact" action="<?= base_url('index.php/users/process') ?>" method="post">
            <div class="row">
              <div class="col-lg-12">
                <div class="fill-form">
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      ...
                      <fieldset>
						...
						<small style="color:red;font-size:13px;"><?= form_error('password'); ?></small>
                      </fieldset>
                    </div>
                    <div class="col-lg-12">
                      <fieldset>
				...
				<br> <a href="<?= base_url('index.php/users/register') ?>" title="Register"><p>Belum memiliki akun?</p></a></p>
                </div>
              </div>
            </div>
        </div>
