...
$this->db->where('data_karyawan.id_pegawai', $id_pegawai);
$pegawai = $this->db->get()->row();
?>
<section class="content" style="padding: 70px;">
    <div class="row mb-2">
        <h4 class="col-xs-12 col-sm-12 mt-0"> <a href="<?= base_url() ?>laporan/absensi"> <i class="fa fa-arrow-left"></i> </a> Detail Absen <?= $pegawai->nama_pegawai ?> </h4>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <select name="bulan" id="bulan" class="form-control">
                            <?php
                            $bulan = array("Silahkan pilih bulan", "Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember");
                            ...
                            for ($a = 0; $a <= 12; $a++) {
                                ...
                                echo ("<option value='$bulan_angka[$a]' $pilih>$bulan[$a]</option>");
                            }
                            ?>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <select name="tahun" id="tahun" class="form-control">
                            ...
                            ?>
                                <option value="<?php echo $x ?>" <?php echo $pilih; ?>><?php echo $x ?></option>
                            <?php
                            }
                            ?>
                        </select>
                ...
                <table class="table table-striped table-bordered" id="laporan_absensi">
                    ...
                    <tbody>
                        ...
                        for ($d = 1; $d <= $jumlahhari; $d++) {
                            ...
                            $absensi = $this->db->get_where('absen', array('id_pegawai' => $id_pegawai, 'tgl_absen' => $date_month_year))->row();
                            if ($absensi) {
