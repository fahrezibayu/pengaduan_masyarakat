...
<section class="content">
    <div class="box">
        <div class="box-body">
            <!-- <form method="POST" action="<?= base_url() ?>absen/save_absen_Keluar"> -->
            <div class="row">
                <center>
                    <div class="col-md-12 take_foto">
                        ...
                        <div class="callout callout-danger notif_gagal2" style="width: 50%;">
                            <h4> Maaf anda belum melakukan absen masuk sebelumnya !</h4>
                        </div>
                        <?php
    ...
    <script type="text/javascript">
        ...
        $(".tombol-simpan").click(function() {
            ...
            // alert(image);
            $.ajax({
                url: '<?= base_url() ?>absen/save_absen_keluar',
                type: 'POST',
                data: {
                    lat: lat,
                    long: long,
                ...
                success: function(response) {
                    ...
                    if (message == 'gagal2') {
                        ...
                        if (message != 'sukses') {
                            document.getElementById('text_gagal').innerHTML = 'Maaf anda sudah melakukan absen pulang sebelumnya pada jam : ' + get.jam;
                            $(".notif_sukses").hide();
                            $(".notif_gagal").show();
                            $(".location").show();
                            document.getElementById('text_lokasi').innerHTML = 'Lokasi anda saat absen pulang';
                            maps(lat_response, long_response);
                        } else {
                            document.getElementById('text_sukses').innerHTML = 'Absen pulang berhasil pada jam : ' + get.jam;
                            $(".location").show();
                            $("#my_camera").hide();
                            $("#results_absen").show();
