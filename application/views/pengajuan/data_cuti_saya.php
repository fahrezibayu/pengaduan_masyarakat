                        ...
                        <tr class="text-sm">
                            ...
                            <td class="text-center" width="160px">
                                <?php if ($this->session->userdata('id_level') == 1) : ?>
                                    <a href="<?= site_url() ?>cuti/edit/<?= $cuti['id_cuti']; ?>" class="btn btn-primary btn-xs">
                                        <i class="fa fa-pencil"></i> Update
                                    </a>
                                    <a href="<?= site_url() ?>cuti/del/<?= $cuti['id_cuti']; ?>" onclick="return confirm('Yakin hapus data?')" class="btn btn-danger btn-xs">
                                ...
                                <?php elseif ($this->session->userdata('id_level') == 2) : ?>
                                    ...
                                    $this->db->where('id_cuti', $cuti['id_cuti']);
